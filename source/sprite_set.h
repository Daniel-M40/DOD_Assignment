...
namespace msc
{
	...
	struct Sprite
	{
		...
		Vector2f anchor;
		// Anchor position in pixels, with 0,0 being top left. This point is used for positioning/rotation
	...
	struct SpriteRenderData
	{
		...
		uint32_t custom1;
		// Padding: match HLSL rules; don't cross 16 byte boundaries; match the other sprite structures
