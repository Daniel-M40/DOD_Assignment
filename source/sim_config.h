...
public:
    ...
    static const int WORLD_SIZE_X = 2000;
    static const int WORLD_SIZE_Y = 2000;
    ...
    constexpr static float ATTRACTOR_NODE_STRENGTH = 100.f;
    constexpr static float IMPULSE_NODE_STRENGTH = 100;
